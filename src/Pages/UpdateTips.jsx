    ...
    <div className="bg-green-50 py-12 sm:py-16 lg:py-20">
      <div className="w-11/12 mx-auto max-w-3xl bg-base-300 p-6 rounded-xl shadow">
        ...
        <form onSubmit={handleUpdateTips} className="space-y-5">
          ...
          {/* Plant */}
          <div>
            <label className="block text-sm font-medium mb-1">Plant Type / Topic</label>
            <input
              type="text"
              name="plant"
              defaultValue={plant}
          ...
          <button
            type="submit"
            className="w-full bg-teal-400 hover:bg-green-700 text-white font-bold py-3 rounded transition duration-300"
          >
            Update Tips
          </button>
        </form>
